...
public class RatingRecordResource {
    ...
    public ResponseEntity<List<RatingRecord>> getAllRatingRecords(Pageable pageable) {
        log.debug("REST request to get a page of RatingRecords");
        Page<RatingRecord> page = ratingRecordRepository.findAll(pageable);
