...
import edu.mum.life.config.Constants;
import edu.mum.life.domain.Authority;
import edu.mum.life.domain.User;
import edu.mum.life.repository.AuthorityRepository;
import edu.mum.life.repository.UserRepository;
import edu.mum.life.security.AuthoritiesConstants;
import edu.mum.life.service.MailService;
import edu.mum.life.service.UserService;
import edu.mum.life.service.dto.PasswordChangeDTO;
import edu.mum.life.service.dto.UserDTO;
import edu.mum.life.web.rest.errors.ExceptionTranslator;
import edu.mum.life.web.rest.vm.KeyAndPasswordVM;
import edu.mum.life.web.rest.vm.ManagedUserVM;
...
public class AccountResourceIT {
    ...
    public void testRegisterValid() throws Exception {
        ...
        validUser.setAuthorities(Collections.singleton(AuthoritiesConstants.STUDENT));
    ...
    public void testRegisterInvalidUsername() throws Exception {
        ...
        invalidUser.setAuthorities(Collections.singleton(AuthoritiesConstants.STUDENT));
    ...
    public void testRegisterAdminIsIgnored() throws Exception {
        ...
        assertThat(userDup.get().getAuthorities()).hasSize(1)
            .containsExactly(authorityRepository.findById(AuthoritiesConstants.STUDENT).get());
    }
